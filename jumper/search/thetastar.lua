...
if (...) then
    ...
    return function (finder, startNode, endNode, clearance, toClear, distance, overrideHeuristic)
        return astar_search(finder, startNode, endNode, clearance, toClear, distance, overrideHeuristic, computeCost)
    end
